...
from tasks.reinforce.save_tasks import *
from tasks.reinforce.train_tasks import *
...
class PipelineTask (InfiniteLoopTask):
  def __init__ (self, path, device, players, enough_size, policy_nets, hdf, context):
    super(PipelineTask, self).__init__(
      ...
      SequentialTask([ # loop task
        ...
        *[EnoughDataTriggerTask(c, enough_size, TrainTask(device, c, policy_nets, 32, 1, context), context) for c in range(2)],
        *[TrainedTriggerTask(
          c,
          SequentialTask([
        ...
        *[RegularSaveTriggerTask(
          ...
          SequentialTask([
            ...
            SaveModelTask(path, c, policy_nets[c], context),
